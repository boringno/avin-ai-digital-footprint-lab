...
Website HTML entries and `docs/llms.txt` are manually maintained. Do not rely on the current docs-index generator to preserve them unless the generation rules are explicitly updated.
