...
- [AVIN AI Digital Footprint OS LLM Guide](docs/llms.txt)
  Website HTML entries are manually maintained until docs-index generator supports HTML files.
  llms.txt entry is manually maintained until docs-index generator supports non-Markdown files.
