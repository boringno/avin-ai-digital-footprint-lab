...
export type ConversationV2MultiIntentAcceptanceCase = {
  ...
  concerns?: readonly { area: string | null; key: string }[];
  id: string;
  text: string;
...
export const CONVERSATION_V2_MULTI_INTENT_ACCEPTANCE_CASES: readonly ConversationV2MultiIntentAcceptanceCase[] = [
  { id: "MI-ONDA-01", treatmentKey: "onda_pro", text: "我雙下巴肉很多，ONDA 適合嗎？最近有活動嗎？", areas: ["jawline"], concerns: [{ area: "jawline", key: "jawline_looseness" }], aspects: ["suitability", "price_campaign"] },
  ...
  { id: "MI-ONDA-11", treatmentKey: "onda_pro", text: "臉頰偏瘦但雙下巴明顯，ONDA 適合嗎？怎麼收費？", areas: ["jawline"], concerns: [{ area: "jawline", key: "jawline_looseness" }], aspects: ["suitability", "price_unspecified"] },
  ...
  { id: "MI-ONDA-15", treatmentKey: "onda_pro", text: "我想改善雙下巴，ONDA 可以評估什麼方向？活動價呢？", areas: ["jawline"], concerns: [{ area: "jawline", key: "jawline_looseness" }], aspects: ["benefits", "suitability", "price_campaign"] },
  ...
  { id: "MI-BOTOX-04", treatmentKey: "botox", text: "我皺眉紋很明顯，肉毒適合嗎？現在怎麼收費？", areas: ["face"], concerns: [{ area: "face", key: "dynamic_wrinkles" }], aspects: ["suitability", "price_unspecified"] },
  ...
  { id: "MI-BOTOX-11", treatmentKey: "botox", text: "臉型偏寬又會咬緊，肉毒可怎麼評估？費用呢？", areas: ["face"], concerns: [{ area: "face", key: "masseter_contour" }], aspects: ["benefits", "suitability", "price_unspecified"] },
  ...
  { id: "MI-BOTOX-15", treatmentKey: "botox", text: "我想改善動態紋，肉毒適合條件和價格都想知道。", areas: ["face"], concerns: [{ area: "face", key: "dynamic_wrinkles" }], aspects: ["suitability", "price_campaign"] },
