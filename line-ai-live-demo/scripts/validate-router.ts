...
const TEST_CASES: TestCase[] = [
  ...
  },
  {
    ...
    message: "鳳凰電波活動是什麼",
    replyIncludes: ["尚未提供 鳳凰電波 的核准價格方案", "免費諮詢"],
  },
  {
  ...
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "treatment_intro:phoenix_thermage",
    message: "鳳凰電波是什麼",
    replyIncludes: ["院內提供", "醫師現場評估"],
    replyExcludes: ["蝴蝶電波"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
  ...
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "treatment_intro:m22_ipl",
    message: "M22 彩衝光可以改善什麼",
    replyIncludes: ["膚色不均", "醫師現場評估"],
    replyExcludes: ["6堂", "10堂", "價格"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "treatment_intro:fractional_laser",
    message: "飛梭雷射是什麼",
    replyIncludes: ["毛孔", "痘疤", "醫師現場評估"],
    replyExcludes: ["3堂", "6堂", "10堂"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "treatment_intro:dermapen4",
    message: "DERMAPEN 4 微針是什麼",
    replyIncludes: ["毛孔", "痘疤", "醫師現場評估"],
    replyExcludes: ["價格", "堂"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "treatment_intro:vivabella",
    message: "你們有薇貝拉嗎",
    replyIncludes: ["薇貝拉", "醫師現場評估"],
    replyExcludes: ["200mg", "50mg", "價格"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
  ...
  },
  {
    expectedDecisionType: "pricing_auto_reply",
    expectedMatchedKey: "pricing_followup",
    message: "M22 彩衝光三堂多少錢",
    replyIncludes: ["尚未提供 M22 彩衝光 的核准價格方案", "免費諮詢"],
    replyExcludes: ["三堂優惠", "自行估價"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
  ...
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "unavailable_treatment_alternative:hydrafacial",
    message: "海菲秀是什麼？",
    replyIncludes: ["沒有提供海菲秀", "水飛梭", "不是相同療程", "現場評估"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "unavailable_treatment_alternative:hydrafacial",
    message: "你們有海菲秀嗎？",
    replyIncludes: ["沒有提供海菲秀", "水飛梭"],
  },
  {
  ...
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "unsupported_energy_device_alternatives",
    message: "海芙是什麼？",
    replyIncludes: ["十蓓電波", "鳳凰電波", "Q+音波", "美國音波 2.0", "其他電音波目前沒有提供", "醫師評估"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "unsupported_energy_device_alternatives",
    message: "無雙電波有嗎？",
    replyIncludes: ["十蓓電波", "鳳凰電波", "Q+音波", "美國音波 2.0"],
  },
  {
    expectedDecisionType: "treatment_intro_reply",
    expectedMatchedKey: "unsupported_energy_device_alternatives",
  ...
  },
  {
    conversationContext: {
      ...
      bookingSession: { action: "use_current", lastActiveAt: VALIDATION_NOW.toISOString(), status: "collecting" },
      introSent: false,
...
TEST_CASES.push({
  ...
  expectedDecisionType: "booking_intake_reply",
  expectedMatchedKey: "booking_intake",
  message: "我要預約肉毒，高雄館，IVAN，0981234567，07/18下午3点",
